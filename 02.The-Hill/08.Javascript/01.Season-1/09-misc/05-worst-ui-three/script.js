...
(() => {
    ...
    let print = () => {
        ...
        phone.innerHTML = `+${input1}${val2}${val3}${val4}`;
    }

    let rollInputOne = () => {
        input1++;
        time1 = setTimeout(rollInputOne, 100);
    ...
    let rollInputTwo = () => {
        input2++;
        time2 = setTimeout(rollInputTwo, 100);
    ...
    let rollInputThree = () => {
        input3++;
        time3 = setTimeout(rollInputThree, 100);
    ...
    let rollInputFour = () => {
        input4++;
        time4 = setTimeout(rollInputFour, 100);
